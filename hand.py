...
hand_items = {
    ...
    '003': Hand("leather gloves", '003', False, 'slashing', 0.1, 0, 20, 30, 0, 0, 0, 0.25, 0, 0, 0, 'none', 'none', 'none', 'none', 3500),
    ...
    '006': Hand("gauntlets", '006', False, 'piercing', 0.4, 200, 0, 200, 0, 0, 0, 0.4, 0, 0, 0, 'none', 'none', 'none', 'none', 40000),
}