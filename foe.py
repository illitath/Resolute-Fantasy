...
enemies_dict = {
    ...
    '019': Foe("leopard", '019', 100, -400, 80, -100, False, 'no_bonus', "glaive", "none", "none", 'slashing', 0.5, 0, 0, 0, 0, 0, 0, 0, 0),
    '020': Foe("goblin scout", '020', 110, 0, 0, 0, False, 'no_bonus', "HP gem +3", "none", "none", 'none', 0, 0, 0, 0, 0, 0, 0, 0, 0),
    '021': Foe("ape", '021', 120, 400, 0, -100, False, 'no_bonus', "DP gem +3", "none", "none", 'bludgeoning', 0.5, 0, 0, -0.4, -0.4, 0, 0, 0, 0),
    ...
    '025': Foe("hunter", '025', 175, 0, 100, -200, False, 'no_bonus', "LUC gem +3", "AP gem +3", "none", 'piercing', 0.8, 0, 0, 0, 0, 0, 0, 0, 0),
    '026': Foe("fiery butcher", '026', 190, 1200, 0, -300, False, 'no_bonus', "royal boots", "none", "none", 'slashing', 0.6, -0.5, 0, -0.2, 0, 0, 0, 0, 0),
    '027': Foe("oak golem", '027', 210, 1400, -300, 500, False, 'no_bonus', "none", "none", "none", 'bludgeoning', 0.5, 0, -0.5, 0.4, -0.8, 0, 0.2, 0, 0),
    '028': Foe("ancient totem", '028', 220, -200, 0, 100, True, 'no_bonus', "royal gloves", "none", "none", 'holy', 1, 0.5, 0.5, -0.8, 0.5, 0.5, 0.5, 0.8, -0.5),
    '029': Foe("forest defender", '029', 240, 1000, -300, 200, False, 'no_bonus', "life wood shield", "none", "none", 'bludgeoning', 0.6, 0, 0, -0.4, -0.4, 0.5, 0, 0, 0),
    '030': Foe("illusion of life", '030', 260, 2000, 0, 0, True, 'no_bonus', "strong sheathing", "oak staff", "none", 'piercing', 0.8, 0, 0, 0, -0.5, 0, 0, -0.5, -0.5),
