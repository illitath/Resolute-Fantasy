...
torso_items = {
    ...
    '002': Torso("woolen shirt", '002', False, 'none', 0, 0, 0, 30, 0, 0, 0, 0, 0.15, 0, 0, 'none', 'none', 'none', 'none', 2000),
    ...
    '006': Torso("light plate", '006', False, 'piercing', 0.4, 0, 0, 400, 0, 0, 0, 0, 0.1, 0, 0, 'none', 'none', 'none', 'none', 34000),
    '007': Torso("strong sheathing", '007', False, 'bludgeoning', 0.4, 400, 0, 400, 0, 0, 0, 0, 0.3, 0, 0, 'none', 'none', 'none','none', 0),
}